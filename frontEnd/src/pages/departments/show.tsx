...
const DepartmentsShow = () => {
  ...
  return (
    <ShowView>
      ...
      <Card className="hoover:shadow-md transition-shadow">
        <CardHeader>
          <CardTitle>Overview</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">{details.department.description ?? "No description provided"}</p>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-lg border border-border bg-muted/20 p-4">
              ...
              <div className="mt-2 text-2xl font-semibold">{details.totals.subject}</div>
            </div>
      ...
      <Card>
        <CardHeader>
          ...
          <Badge variant="secondary">{details.totals.subject}</Badge>
        </CardHeader>
        <CardContent>
